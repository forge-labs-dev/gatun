 ...
 * <ul>
 *   <li>Request history via ring buffer</li>
 *   <li>Session-level counters</li>
 *   <li>JFR event state</li>
 * </ul>
 */
public class SessionObserver {
  ...
  public void onRequestStart(long requestId, byte action, String target) {
    ...
    currentJfrEvent = GatunEvents.beginRequest(
        sessionId, requestId, currentRequest.actionName(), target);
  }
